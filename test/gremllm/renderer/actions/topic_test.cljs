...
(deftest bootstrap-test
  (is (= [[:topic.effects/list {:on-success [:topic.actions/determine-initial-topic [:promise/success-value]]
...
(deftest determine-initial-topic-test
  (testing "when topics exist"
    (is (= [[:topic.effects/load-latest-topic {:on-success [:topic.actions/restore-or-create-topic [:promise/success-value]]}]]
